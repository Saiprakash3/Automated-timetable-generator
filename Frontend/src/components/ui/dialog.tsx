...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // data-closed:animate-out is dropped — Radix's unmount-after-exit-animation
        // never fires in this environment (verified: animation runs, data-state
        // flips to "closed", but the node + its pointer-events:auto backdrop stay
        // mounted indefinitely, blocking the whole page). Entry animation kept;
        // closing is now instant rather than stuck-forever.
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Same fix as DialogOverlay above — no data-closed:animate-out.
